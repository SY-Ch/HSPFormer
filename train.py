...
data_loader_train = DataLoader(train_set, batch_size = cfg["TRAIN"]["batch_size"],
...
if not cfg["continue_train"]:
    ...
    trainer.fit(model=model, train_dataloaders=data_loader_train, val_dataloaders=data_loader_val,ckpt_path=pth_dir)
